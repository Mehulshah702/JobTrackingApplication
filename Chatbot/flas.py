...
# ------------------ ProCollab Hub Chatbot Setup (TF-IDF-based) ------------------ #

with open("procollab.txt", 'r', errors='ignore') as f:
    raw_doc = f.read()
...
# Function to generate response from ProCollab Hub chatbot
def procollab_response(user_response):
...
def get_bot_response():
    ...
    response = procollab_response(user_input)
    if response is None:
